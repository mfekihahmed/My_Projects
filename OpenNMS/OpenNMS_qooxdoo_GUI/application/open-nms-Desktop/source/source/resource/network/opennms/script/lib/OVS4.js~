...
OVS4 = draw2d.shape.basic.Image.extend({
    ...
    onClick: function(){
        ...
        // $.getJSON('ajax/test.json', function(data) {
            ...
            var data = {"resourceType": "Open vSwitch","manufacturerDescription": "Ericsson, PqDp","hardwareDescription": "Open vSwitch","softwareDescription": "1.3","serialNumber": "","humanDescription": "OPENSWITCH","dataPathId": 000000000005,"maxFlowperTable": 1024,"nbTables": 256,"capabilities": ["OFPC_FLOW_STATS", "OFPC_TABLE_STATS", "OFPC_PORT_STATS"],"ports": [
