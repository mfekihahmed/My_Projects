qx.Class.define("ca.opennms.ui.sections.AlarmsSection", {
	extend : ca.opennms.ui.navigation.SectionPanel,
	construct : function() {
		this.base(arguments, "Alarms", "resource/icons/16/alarms.png");
		this.setWidth(250);
		this.setValue(false);
		...
		this.add(new qx.ui.basic.Atom("Critical", "resource/icons/16/alarms/critical.png"), {
			row : 1,
			column : 0
		});
		this.add(new qx.ui.basic.Atom("Major", "resource/icons/16/alarms/major.png"), {
			row : 2,
			column : 0
		});
		this.add(new qx.ui.basic.Atom("Minor", "resource/icons/16/alarms/minor.png"), {
			row : 3,
			column : 0
		});
		this.add(new qx.ui.basic.Atom("Warning", "resource/icons/16/alarms/warning.png"), {
			row : 4,
			column : 0
		});
