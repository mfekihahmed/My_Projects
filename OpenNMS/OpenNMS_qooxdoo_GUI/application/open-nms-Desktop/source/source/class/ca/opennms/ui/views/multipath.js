qx.Class.define("ca.opennms.ui.views.multipath", {
	extend : qx.ui.tabview.Page, 
        //include : [qx.dev.unit.TestCase],
        
	construct : function() {
		this.base(arguments, "Multipath", "images/icons/16/reports.png");
      ...
      frame.setSource("http://172.16.0.254/topology/topology.html");
      this.add(frame);
