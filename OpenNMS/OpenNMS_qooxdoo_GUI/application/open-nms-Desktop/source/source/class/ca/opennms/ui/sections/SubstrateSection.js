qx.Class.define("ca.opennms.ui.sections.SubstrateSection", {
	extend : ca.opennms.ui.navigation.SectionPanel,
	construct : function() {
		this.base(arguments, "Infrastructure", "resource/images/icons/16/infrastructure.png");
		this.setWidth(250);
	...
	members : {
		_createToolbar: function() {
			...
			toolbar.add(new qx.ui.form.Button("New","resource/images/icons/16/add.png"));
			toolbar.add(new qx.ui.form.Button("Delete","resource/images/icons/16/delete.png"));
			return toolbar;
		},
