...
OVS9 = draw2d.shape.basic.Image.extend({
    ...
    onMouseEnter: function(){
        ...
        if(this.listVm.length < 1){
            this.bareMetal.append('<div><b>OVS 10</b></div>');
        }else{
    ...
    onClick: function(){
        ...
        // $.getJSON('ajax/test.json', function(data) {
            ...
            var data = {"resourceType": "Open vSwitch","manufacturerDescription": "Ericsson, PqDp","hardwareDescription": "Open vSwitch","softwareDescription": "1.3","serialNumber": "","humanDescription": "OPENSWITCH","dataPathId": "0000000000d3","maxFlowperTable": 1024,"nbTables": 256,"capabilities": ["OFPC_FLOW_STATS", "OFPC_TABLE_STATS", "OFPC_PORT_STATS"],"ports": [
