...
ovsslice = draw2d.shape.basic.Image.extend({
    ...
    onMouseEnter: function(){
        ...
        if(this.listVm.length < 1){
            this.bareMetal.append('<div><b>Open NMS Slice Node</b></div>');
        }else{
