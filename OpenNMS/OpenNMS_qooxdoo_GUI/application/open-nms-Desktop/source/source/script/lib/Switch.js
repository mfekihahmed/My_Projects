...
Switch = draw2d.shape.basic.Image.extend({
    ...
    onMouseEnter: function(){
        ...
        if(this.listVm.length < 1){
            this.bareMetal.append('<div><b>H. Switch</b></div>');
        }else{
    ...
    onClick: function(){
        ...
        // $.getJSON('ajax/test.json', function(data) {
            ...
            var data = {"id": "dc1bf072-0593-492f-a368-4f45ecebe064","resourceType": "Ericsson Hardware SWITCH","manufacturerDescription": "Ericsson, Inc.","hardwareDescription": "Switch","softwareDescription": "","serialNumber": "","humanDescription": "Ericsson SWITCH","ports": [],"connectedTo": []};
