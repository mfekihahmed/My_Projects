 ...
 */
qx.Class.define("ca.opennms.ui.dialogs.LoginDialog",
{
  ...
  members :
  {
    ...
    */     
    ...
    {      
       ...
       * Labels 
       */
      var labels = [this.tr("Name"), this.tr("Password")];//, this.tr("Hardware Key") ];
      ...
      this._OTPpassword = new qx.ui.form.PasswordField();
      
      this._OTPpassword.addListener("keypress",function(e){
      ...
      /*gridContainer.add(this._OTPpassword .set({
        allowShrinkX: false,
        paddingTop: 3
      }), {row: 2, column : 1});
      */
     /*
      ...
      loginButton.setIcon("images/icons/16/security.png");//icons/16/security.png
      loginButton.setIconPosition("right");
