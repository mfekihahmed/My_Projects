qx.Class.define("ca.opennms.ui.sections.OrgSection", {
extend: ca.opennms.ui.navigation.SectionPanel,
construct: function() {
	this.base(arguments,"Organization & Users","resource/icons/16/org.png");
	this.setWidth(250);
   this.setValue(false);
...
members: { 
   ...
   _getContentTree: function() {
         ...
         var url = qx.util.ResourceManager.getInstance().toUri("resource/data/resources/5.json");
