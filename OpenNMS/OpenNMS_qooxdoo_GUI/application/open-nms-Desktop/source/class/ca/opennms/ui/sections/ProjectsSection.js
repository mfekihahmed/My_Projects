qx.Class.define("ca.opennms.ui.sections.ProjectsSection", {
	extend : ca.opennms.ui.navigation.SectionPanel,
	construct : function() {
		this.base(arguments, "Projects", "resource/images/icons/16/pawn.png");
		this.setWidth(250);
	...
	members : {
		_createToolbar : function() {
			...
			toolbar.add(new qx.ui.form.Button("New", "resource/images/icons/16/pawn_add.png"));
			toolbar.add(new qx.ui.form.Button("Delete", "resource/images/icons/16/pawn_delete.png"));
			return toolbar;
		},
		...
		_getContentTree : function() {
			...
			var url = qx.util.ResourceManager.getInstance().toUri("resource/data/resources/2.json");
