qx.Class.define("ca.opennms.ui.views.EcoloticInfrastructure", {
	extend : qx.ui.tabview.Page,
	construct : function() {
		this.base(arguments, "Ecolotic Topology", "images/icons/16/infrastructures.png");
		...
		this.setShowCloseButton(false);
                ...
                frame.setSource("http://207.162.8.249/resource/topology/topology.html");
                this.add(frame);
