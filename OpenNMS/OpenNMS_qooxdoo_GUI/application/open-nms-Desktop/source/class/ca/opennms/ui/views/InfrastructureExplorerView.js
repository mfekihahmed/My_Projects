qx.Class.define("ca.opennms.ui.views.InfrastructureExplorerView", {
	...
	construct : function() {
		...
		var page2 = new qx.ui.tabview.Page("Open NMS Topology", "images/icons/16/infra.png");
		...
		page2.setPaddingTop(3);
                ...
                frame.setSource("resource/network/examples/opennmstopo.html");
                page3.add(frame);
                ...
                frame1.setSource("resource/network/examples/multipathtopo.html");
                page4.add(frame1);
