...
OvsSlice3 = draw2d.shape.basic.Image.extend({
    ...
    onMouseEnter: function(){
        ...
        if(this.listVm.length < 1){
            this.bareMetal.append('<div><b>Slice 3</b></div>');
        }else{
    ...
    onClick: function(){
        ...
        // $.getJSON('ajax/test.json', function(data) {
            ...
            var data = {"resourceType": "Open NMS Slice","manufacturerDescription": "Ericsson, Synchromedia","hardwareDescription": "Open vSwitch","softwareDescription": "1.3","serialNumber": "","humanDescription": "OPENSWITCH","dataPathId": "0000000000dF","maxFlowperTable": 1024,"nbTables": 2,"capabilities": ["OFPC_FLOW_STATS", "OFPC_TABLE_STATS", "OFPC_PORT_STATS"],"ports": [
...
{"portNo": "PORT_3","hwAddr": "08:9e:01:93:5e:26","name": "ge-1/1/3","config": [],"state": [],"curr": ["OFPPF_1GB_FD", "OFPPF_COPPER", "OFPPF_AUTONEG"],"advertised": ["OFPPF_10MB_HD", "OFPPF_10MB_FD", "OFPPF_100MB_HD", "OFPPF_100MB_FD", "OFPPF_1GB_FD", "OFPPF_COPPER", "OFPPF_AUTONEG"],"supported": ["OFPPF_10MB_HD", "OFPPF_10MB_FD", "OFPPF_100MB_HD", "OFPPF_100MB_FD", "OFPPF_1GB_FD", "OFPPF_COPPER", "OFPPF_AUTONEG"],"peer": ["OFPPF_10MB_HD", "OFPPF_10MB_FD", "OFPPF_100MB_HD", "OFPPF_100MB_FD", "OFPPF_1GB_FD", "OFPPF_COPPER"],"currSpeed": 1000000,"maxSpeed": 1000000}],"connectedTo": []};
            ...
            for(var i = 0; i < data.ports.length; i++){
                if(i == 0){
                    htmlPorts = '<tr>' +
                                    '<td id="portSpan" rowspan="'+data.ports.length+'">vPorts</td>' +
