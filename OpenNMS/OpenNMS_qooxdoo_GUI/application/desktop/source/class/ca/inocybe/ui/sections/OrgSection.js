qx.Class.define("ca.inocybe.ui.sections.OrgSection", {
extend: ca.inocybe.ui.navigation.SectionPanel,
construct: function() {
	this.base(arguments,"Organization & Users","icons/16/org.png");
	this.setWidth(250);
   this.setValue(false);
...
members: { 
   ...
   _getContentTree: function() {
         ...
         var url = qx.util.ResourceManager.getInstance().toUri("data/resources/5.json");
