qx.Class.define("ca.inocybe.ui.sections.BlueprintSection", {
extend: ca.inocybe.ui.navigation.SectionPanel,
construct: function() {
	this.base(arguments,"Blueprint","icons/16/blueprint.png");
	this.setWidth(250);
      this.setValue(false);
...
members: { 
   ...
   _getContentTree: function() {
         ...
         var url = qx.util.ResourceManager.getInstance().toUri("data/resources/4.json");
