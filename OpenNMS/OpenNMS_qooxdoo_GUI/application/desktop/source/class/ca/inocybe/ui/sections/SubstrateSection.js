qx.Class.define("ca.inocybe.ui.sections.SubstrateSection", {
	extend : ca.inocybe.ui.navigation.SectionPanel,
	construct : function() {
		this.base(arguments, "Infrastructure", "images/icons/16/substrate.png");
		this.setWidth(250);
	...
	members : {
		_createToolbar: function() {
			...
			toolbar.add(new qx.ui.form.Button("New","images/icons/16/substrate_add.png"));
			toolbar.add(new qx.ui.form.Button("Delete","images/icons/16/substrate_delete.png"));
			return toolbar;
		},
