...
qx.Class.define("ca.inocybe.ui.core.perspective.PerspectiveSelector", {
	...
	//				console.log(perspective);
					var button = new ca.inocybe.ui.core.perspective.PerspectiveSelectorButton(perspective.getTitle(), perspective.getIcon());
